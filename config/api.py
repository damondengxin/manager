...
class Config(object):
    ...
    def conf():
        ...
        with open(Config.config_path) as cfgfile:
            ...
            result["log_path"] = Config.rawconfig.get('config', 'log_path')
            result["log_level"] = Config.rawconfig.get('config', 'log_level')
        return result
    ...
    def db():
        ...
        with open(Config.config_path) as cfgfile:
            Config.rawconfig.read_file(cfgfile)
            result["engine"] = Config.rawconfig.get('db', 'engine')
            result["host"] = Config.rawconfig.get('db', 'host')
            result["port"] = Config.rawconfig.get('db', 'port')
            result["user"] = Config.rawconfig.get('db', 'user')
            result["password"] = Config.rawconfig.get('db', 'password')
            result["database"] = Config.rawconfig.get('db', 'database')
        return result
    ...
    def redis():
        ...
        with open(Config.config_path) as cfgfile:
            Config.rawconfig.read_file(cfgfile)
            result["host"] = Config.rawconfig.get('redis', 'host')
            result["port"] = Config.rawconfig.get('redis', 'port')
            result["user"] = Config.rawconfig.get('redis', 'user')
            result["password"] = Config.rawconfig.get('redis', 'password')
        return result
    ...
    def jenkins():
        ...
        with open(Config.config_path) as cfgfile:
            Config.rawconfig.read_file(cfgfile)
            result["url"] = Config.rawconfig.get('jenkins', 'url')
            result["user"] = Config.rawconfig.get('jenkins', 'user')
            result["password"] = Config.rawconfig.get("jenkins","password")
        return  result
    ...
    def mongodb():
        ...
        with open(Config.config_path) as cfgfile:
            Config.rawconfig.read_file(cfgfile)
            result["host"] = Config.rawconfig.get('mongodb', 'host')
            result["port"] = Config.rawconfig.get('mongodb', 'port')
            result["user"] = Config.rawconfig.get('mongodb', 'user')
            result["password"] = Config.rawconfig.get('mongodb', 'password')
            result["collection"] = Config.rawconfig.get('mongodb', 'collection')
        return  result
    ...
    def webssh():
        ...
        with open(Config.config_path) as cfgfile:
            Config.rawconfig.read_file(cfgfile)
            result["webssh_domain"] = Config.rawconfig.get('webssh', 'domain')
            result["token"] = Config.rawconfig.get('webssh', 'token')
            result["password"] = Config.rawconfig.get('webssh', 'password')
        return  result
    ...
    def host():
        ...
        with open(Config.config_path) as cfgfile:
            Config.rawconfig.read_file(cfgfile)
            result["user"] = Config.rawconfig.get("host", "user")
            result["password"] = Config.rawconfig.get("host", "password")
        return result
    ...
    def email():
        ...
        with open(Config.config_path) as cfgfile:
            ...
            result["email"] = Config.rawconfig.get("email", "email")
            result["password"] = Config.rawconfig.get("email", "password")
    ...
    def gateone():
        ...
        with open(Config.config_path) as cfgfile:
            Config.rawconfig.read_file(cfgfile)
            result["api_key"] = Config.rawconfig.get("gateone", "api_key")
            result["gateone_server"] = Config.rawconfig.get("gateone", "gateone_server")
        return result
